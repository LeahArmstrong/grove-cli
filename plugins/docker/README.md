...
For projects whose Docker services are defined in a shared, external compose setup (e.g., a central `compose-dev` directory that orchestrates multiple apps). In this mode:
